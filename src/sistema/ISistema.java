...
/**
 * os "imports" são utilizados para chamar (importar) os pacotes e suas respectivas classes que 
 * serão utilizadas para a execução do código. Sem esse processo os metodos não teriam sua funcionalidade.
 */
...
/**
 * Interface que define as operações disponíveis no sistema de aluguel de
 * veículos.
 */
