...
/**
 * Implementação da interface ISistema que define as operações disponíveis no
 * sistema de aluguel
 * de veículos.
 */
public class Sistema implements ISistema {
    ...
    public Sistema() {
        ...
        /**
         * São criados métodos que possibilita o cadastro de funcionários, clientes e
         * alugueis ativos.
         * Esse servirá para que quando necessário acessar o Sistema para processar uma
         * transação
         * de aluguél o funcionário necessite apenas das informações do seu login e sua
         * senha.
         */
        cadastrados.adicionar(
                new Funcionario("Eduardo", "000.000.000-00", "Rua S, 22", "00 90000-0000", "Vendedor", 10500.0,
                        "eduardo123"));

        cadastrados.adicionar(
                new Funcionario("Mario", "000.000.000-01", "Rua D, 12", "00 60000-0000", "Vendedor", 500.0,
                        "mario123"));

        /**
         * Cadastrar um cliente no sistema.
         */
        cadastrarCliente("Marcelo", "000.000.002-01", "10/03/2005", "Rua N - 45", "(54) 99996-3305",
                "marcelo@marcelo.marcelo", null);
        /**
         ...
         */
        alugueisAtivos.adicionar(new Aluguel("10", veiculos.pesquisar("1"),
                (Cliente) cadastrados.pesquisar("00000000201"), (Funcionario) cadastrados.pesquisar("1"), (10)));
    ...
    public List<Aluguel> getAlugueisAtivos() {
        return alugueisAtivos.pesquisar();
    }
     ...
     */
    public Armazenamento<Aluguel> getArmazenamentoAlugueis() {
     ...
     *         Após isso, adiciona o cliente ao armazenamento de pessoas
     *         cadastradas.
     */
    public boolean cadastrarCliente(String nome, String cpf, String dataNascimento, String endereco, String telefone,
            String email, String cnh) {
     ...
     * 
     *         Remove o cliente com o ID fornecido do armazenamento de pessoas
     *         cadastrada.
     */
     ...
     */
    public boolean cadastrarFuncionario(String id, String nome, String cpf, String endereco, String telefone,
     ...
     * @throws AluguelNaoEncontradoException Exceção lançada se o aluguel não for
     *                                       encontrado.
     * @throws ClienteNaoEncontradoException Exceção lançada se o cliente não for
     *                                       encontrado.
     * 
     *                                       Pesquisa os aluguéis ativos do cliente
     *                                       com base no ID do cliente
     *                                       Verifica se o cliente possui aluguéis
     *                                       ativos
     *                                       Procura pelo aluguel associado ao
     *                                       veículo e finaliza-o
     */
    public void finalizarAluguel(String idCliente, String idVeiculo)
            throws AluguelNaoEncontradoException, ClienteNaoEncontradoException {
    ...
    /**
     * Realiza o aluguel de um veículo para um cliente e adiciona o aluguel à lista
     * de aluguéis ativos.
     * 
    ...
    public boolean alugarVeiculo(Cliente cliente, Veiculo veiculo, int dias, Funcionario funcionarioResponsavel) {
        ...
        Aluguel aluguel = new Aluguel(UniqueIDGenerator.generateUniqueID(), veiculo, cliente, funcionarioResponsavel,
                dias);
    ...
    /**
     * Pesquisa aluguéis ativos realizados por um determinado cliente com base no
     * seu ID.
     * 
     ...
     *                                       encontrado.
     * 
     *                                       Verifica se o cliente com o ID
     *                                       fornecido existe
     *                                       Verifica se o cliente possui aluguéis
     *                                       ativos e os retorna
     */
